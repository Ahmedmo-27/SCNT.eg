    ...
    <Layout>
      <div className="mx-auto max-w-6xl px-5 py-16 sm:px-8 sm:py-20">
        <header className="max-w-2xl">
          ...
          <h1 className="font-serif text-4xl text-scnt-text sm:text-5xl">Contact</h1>
          <p className="mt-4 text-lg text-scnt-text-muted">
            Reach us on Instagram or by email — we will get back to you as soon as we can.
          </p>
        </header>
        ...
        <ul className="mx-auto grid max-w-3xl gap-6 sm:grid-cols-2">
          ...
          >
            <a
              ...
              className="block h-full focus:outline-none focus-visible:ring-2 focus-visible:ring-scnt-text/20 focus-visible:ring-offset-2 focus-visible:ring-offset-scnt-bg rounded-2xl"
            >
              <Card asMotion={false} className="h-full p-8 transition-[transform,box-shadow] duration-[650ms] ease-[cubic-bezier(0.22,1,0.36,1)] hover:-translate-y-1 hover:shadow-[0_24px_60px_-32px_rgba(42,38,34,0.14)]">
                ...
                <p className="mt-3 text-sm leading-relaxed text-scnt-text-muted">
                  Follow and message us on Instagram.
                </p>
          ...
          >
            ...
            >
              <Card asMotion={false} className="h-full p-8 transition-[transform,box-shadow] duration-[650ms] ease-[cubic-bezier(0.22,1,0.36,1)] hover:-translate-y-1 hover:shadow-[0_24px_60px_-32px_rgba(42,38,34,0.14)]">
                ...
                <p className="mt-3 break-all font-serif text-xl text-scnt-text sm:text-2xl">
                  {EMAIL}
                </p>
                <p className="mt-3 text-sm leading-relaxed text-scnt-text-muted">
                  Write us for orders, questions, or collaborations.
                </p>
                <span className="mt-6 inline-flex items-center gap-2 text-xs text-scnt-text-muted">
                  Send email
                  <EightPointStar size={9} />
