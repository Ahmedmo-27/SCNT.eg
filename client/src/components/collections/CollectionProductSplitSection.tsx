...
export function CollectionProductSplitSection({ product, collection }: Props) {
  ...
  return (
    <div className="relative min-h-[calc(100svh-var(--scnt-header-h,5.5rem))] lg:h-auto">
      <div
      ...
      <div className="relative mx-auto h-full w-full overflow-x-hidden">
        <div className="flex h-full w-full flex-col lg:grid lg:min-h-[calc(100svh-var(--scnt-header-h,5.5rem))] lg:grid-cols-[minmax(0,1.02fr)_minmax(0,0.64fr)_minmax(0,1.16fr)] lg:items-stretch">
          <div className="order-2 flex flex-1 flex-col justify-start px-5 py-8 pb-12 lg:order-1 lg:h-auto lg:justify-center lg:overflow-visible lg:px-8 lg:py-4 lg:pe-12">
